...
export class TermsOfService extends Component {
    render() {
        return (
            <div>
                <Modal trigger={<Header as="h5" color="blue" className={styles.link}>Terms of Service</Header>} closeIcon>
                    <Modal.Header>Terms of Service</Modal.Header>
                    <Modal.Content scrolling>
                        Welcome to the ChatbotResources Portal. <br />In order to proceed, we would like you to look at our consent form. The assent form can be accessed <a href="/static/public/assent.pdf" target="_blank">here</a>.<br /><br />
            ...
            and make sure you understand its contents.<br /><br />
                        ...
                        The main purpose of the study is to find new ways to improve access to services and information for individuals with intellectual disability and their families. This research study is sponsored by the Kids
            Brain Health Network (KBHN).<br /><br />
                        <b>What will I be asked to do?</b><br /><br />
                        You will be asked to provide your email and create a password if you want. You will be able to provide resources that we may use to add to our database of helpful resources aimed towards helping parents, educators and health workers manage children with neurodevelopmental diagnoses. These resources may be provided publicly in our portal. <br /><br />
            ...
            team.<br /><br />
                        ...
                        During the study we will be collecting information about you and the resources you are submitting.<br /><br />
            ...
            computers.<br /><br />
                        ...
                        information collected about the user and the individual for whom they are using the ChatbotResources Portal, may be
