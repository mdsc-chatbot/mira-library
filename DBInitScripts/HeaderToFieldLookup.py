...
def getSQLIndex(version, csvIndex, rowtext):
    ...
    for id in mycursor:
        #1-12 are resource fields
        #13-999 are tags(so subtract 12 to get actual tag id in database)
        return id[0]+12
