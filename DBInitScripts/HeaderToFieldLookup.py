...
def indexToLetters(index):
    ...
    if (index >= 26):
        ...
        fls = chr(ord('@')+int(fl))
    sl = index%26
    #minus 1 to match 1 indexing
    sls = chr(ord('A')+int(sl))
    return fls + sls
...
def getSQLIndex(version, csvIndex, rowtext):
    ...
    if csvIndex == 15:
        ...
        lookupname = "Healthcare worker/Nurse"
        lookupcat = "User Group"
    elif csvIndex == 26:
        lookupname = "Healthcare worker/Practising or Retired Physician"
        lookupcat = "User Group"
    elif csvIndex == 27:
        lookupname = "Healthcare worker/First Responder"
        lookupcat = "User Group"
    elif csvIndex == 28:
        lookupname = "Healthcare worker/Medical Student"
        lookupcat = "User Group"
    elif csvIndex == 29:
        lookupname = "Healthcare worker/Resident Doctor"
        lookupcat = "User Group"
    elif csvIndex == 30:
        lookupname = "Military"
        lookupcat = "User Group"
        ...
        lookupname = "Family member of physician or medical learner"
        lookupcat = "User Group"
    elif csvIndex == 34:
        lookupname = "Family member of healthcare worker (other)"
        lookupcat = "User Group"
    elif csvIndex == 35:
        lookupname = "Male"
        ...
        lookupname = "Cantonese"
        lookupcat = "Language"
    elif csvIndex == 49:
        lookupname = "Tagalog (Pilipino, Filipino)"
        lookupcat = "Language"
    elif csvIndex == 50:
        lookupname = "Arabic"
        lookupcat = "Language"
        ...
        lookupname = "Infant (0-1 years)"
        lookupcat = "Age Group"
    elif csvIndex == 81:
        lookupname = "Toddler (1-3 years)"
        lookupcat = "Age Group"
    elif csvIndex == 82:
        lookupname = "Preschool (3-4 years)"
        lookupcat = "Age Group"
    elif csvIndex == 83:
        lookupname = "Child/Youth (0-17 years)"
        lookupcat = "Age Group"
    elif csvIndex == 84:
        ...
        lookupname = "Antisocial Personality Disorder (ASPD), Psychopathy, and Conduct Disorder"
        lookupcat = "Health Issue Group"
    elif csvIndex == 201:
        ...
        lookupname = "Borderline Personality Disorder (BPD)"
        lookupcat = "Health Issue Group"
    elif csvIndex == 207:
        lookupname = "Bulimia"
        lookupcat = "Health Issue Group"
        ...
        lookupname = "Operational Stress Injury (OSI)"
        lookupcat = "Health Issue Group"
    elif csvIndex == 235:
        lookupname = "Overweight and Obesity"
        lookupcat = "Health Issue Group"
    elif csvIndex == 236:
        lookupname = "Pandemic (e.g. COVID/Coronavirus), Disasters and Related Emergencies"
        lookupcat = "Health Issue Group"
    elif csvIndex == 237:
        lookupname = "Parenting"
        lookupcat = "Health Issue Group"
    elif csvIndex == 239:
        lookupname = "Post-Traumatic Stress Disorder (PTSD), Trauma and Abuse"
        lookupcat = "Health Issue Group"
    elif csvIndex == 240:
        lookupname = "Resiliency"
        lookupcat = "Health Issue Group"
    elif csvIndex == 241:
        ...
        lookupname = "Sleep Problems and Disorders"
        lookupcat = "Health Issue Group"
    elif csvIndex == 247:
        lookupname = "Social Skills and Life Skills"
        lookupcat = "Health Issue Group"
    elif csvIndex == 250:
        lookupname = "Stress"
        lookupcat = "Health Issue Group"
        ...
        return -2 #custom mental health concern
    elif csvIndex == 256:
        lookupname = "Website"
        ...
        letters = indexToLetters(csvIndex)
        print("UNHANDLED TAG: Import index '" + letters + "'(" + str(csvIndex) + ") is unhandled. Please add the missing logic then run the importer again.")
        return -1
